...
public class ShiftDto implements Serializable {
    ...
    public ShiftDto(Shift shift) {
        ...
        if (shift.getShiftId() != null) {
            this.id = shift.getShiftId().longValue();
        }
        if (shift.getShiftEmployee() != null) {
            this.employee = new EmployeeDto(shift.getShiftEmployee());
        }
        ...
        if (shift.getShiftVersion() != null) {
            this.version = shift.getShiftVersion().longValue();
        }
    }
    public Long getId() {
        return id;
